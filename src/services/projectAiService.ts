...
const CATEGORY_INSTRUCTIONS: Record<string, string> = {
  ...
  "science": `Authentic science narratives grounded in verified, real-world science. Focus on documented discoveries, experiments, observations, missions, and peer-reviewed findings across physics, chemistry, biology, medicine, earth science, astronomy, engineering, and the history of science. Emphasize evidence-first storytelling: what was observed, how it was tested, what instruments or methods were used, what data supported (or refuted) the idea, and how the scientific community validated it over time.

Cover major science arcs and landmark episodes such as: cosmology (Big Bang evidence, cosmic microwave background, expansion of the universe, inflation debates), astronomy and space exploration (heliocentrism, Kepler’s laws, Galileo’s observations, Newton’s gravity, discovery of Neptune, black holes, pulsars, exoplanets, Hubble’s findings, Apollo missions, Mars rovers, space telescopes, planetary formation), physics (electromagnetism, thermodynamics, relativity, quantum mechanics, particle physics, Higgs boson, gravitational waves), chemistry (periodic table, atomic theory, radioactivity, polymers, pharmaceuticals, catalysts, materials science, batteries), biology and evolution (Darwin’s natural selection, Mendelian genetics, DNA structure, central dogma, evolutionary evidence, speciation, microbiology), medicine and public health (germ theory, anesthesia, antiseptics, antibiotics, vaccines, epidemiology, imaging—X-ray/CT/MRI, organ transplantation, genomics, CRISPR), earth and climate science (plate tectonics, volcanoes, earthquakes, geologic time, ice cores, carbon cycle, climate modeling, extinction events), computing and engineering (transistors, semiconductors, internet foundations, cryptography, satellites, robotics, AI milestones), and high-stakes science ethics (human subjects protections, bioethics, dual-use research, environmental tradeoffs, scientific fraud cases and corrections).

Emphasize the human side of science with dramatic but accurate detail: curiosity, rivalry, skepticism, institutional resistance, funding constraints, lab accidents, failed trials, unexpected results, replication battles, and the long path from hypothesis to consensus. Include key figures (scientists, engineers, physicians, lab teams), institutions (universities, labs, space agencies, journals), and historical context (politics, wars, industrial shifts, technology limits). Focus on turning points: the “first observation,” the decisive experiment, the dataset that changed minds, the moment a theory broke, or the breakthrough that enabled a new field.

Highlight scientific reasoning explicitly: hypotheses vs. theories, correlation vs. causation, controls and confounders, measurement uncertainty, statistical significance (when relevant), peer review, replication, meta-analyses, and how consensus forms. Clearly separate what is established from what is uncertain or debated using precise language (“evidence suggests,” “hypothesis,” “under active research,” “not yet confirmed,” “competing models”). Avoid sensationalism and overclaiming.

Include accurate technical detail at the right level: dates, locations, instruments (telescopes, accelerators, microscopes, sequencing, satellites), experimental setup, sample size (where relevant), what was measured, and what the results meant. Use vivid storytelling, but never sacrifice correctness. When simplifying, preserve the core truth and note simplifications if needed.

Strict accuracy rules: do not invent quotes, citations, discoveries, or credentials. Do not attribute thoughts or dialogue to real scientists unless it is from a verifiable source. Do not present speculation as fact. Do not claim “proof” where science only provides evidence. Do not use fake “ancient secrets,” conspiracy framing, or miracle cures. If reporting a disputed or evolving area, present the leading interpretations and what evidence would change the conclusion.

Every narrative must include: (1) the scientific question/problem, (2) the evidence trail, (3) the methods/tools used, (4) what was learned, (5) limitations/uncertainties, and (6) real-world impact (technology, medicine, society, environment). Conclude with “what this means today” and “what scientists are still trying to figure out.”

Format and delivery style: cinematic documentary tone with clear structure—Hook → Setup → Investigation → Breakthrough → Pushback/Verification → Consequences → Modern relevance. Use strong scene-like progression with concrete visuals (lab bench, observatory night, field expedition, control room, hospital ward) while staying faithful to reality. Provide key terms and definitions as needed for clarity.

IT’S EXTREMELY IMPORTANT THAT ALL CONTENT IS BASED ON REAL, VERIFIABLE SCIENCE AND MAINTAINS FACTUAL ACCURACY, WITH SOURCES TRACEABLE TO PEER-REVIEWED RESEARCH OR REPUTABLE SCIENTIFIC INSTITUTIONS.`
};
